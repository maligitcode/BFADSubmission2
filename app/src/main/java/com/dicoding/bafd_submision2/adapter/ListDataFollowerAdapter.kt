...
class ListDataFollowerAdapter(private val listDataUsersGithub: ArrayList<FollowersResponse>) :
    RecyclerView.Adapter<ListDataFollowerAdapter.ListDataHolder>() {

    fun setData(items: ArrayList<FollowersResponse>) {
    ...
    inner class ListDataHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(dataUsers: FollowersResponse) {
            with(itemView) {
